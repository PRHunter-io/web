  ...
  return (
    ...
    >
      ...
      <div className="bg-white px-8 pt-9 pb-7 rounded-4 mb-9 feature-cardOne-adjustments">
        ...
        <Link href={githubUrl}>
          <a className="font-size-3 d-block mb-2 text-gray">{fullRepoName}</a>
        </Link>
        <h2 className="mt-n4">
          <Link href={`/bounties/${bounty.id}`} passHref>
        ...
        <div className="col-md-12">
          <ul className="d-flex list-unstyled mr-n3 flex-wrap mr-n8 justify-content-md-start">
            <li className="mt-2 mr-8 font-size-small text-black-2 d-flex">
              ...
              <span className="font-weight-semibold">{bounty.bounty_type}</span>
            </li>
            <li className="mt-2 mr-8 font-size-small text-black-2 d-flex">
              <i className="fas fa-signal pr-3" />
              <span className="font-weight-semibold">{bounty.experience}</span>
            </li>
            <li className="mt-2 mr-8 font-size-small text-black-2 d-flex">
